package com.zwb.filepicker.adapter;
...
import com.zwb.filepicker.utils.Constant;
...
//    }
    ...
    public void onBindViewHolder(final PathViewHolder holder, final int position) {
        ...
        if (file.isFile()) {
            ...
            holder.tvName.setText(file.getName());
            //文件大小过滤
            List files = FileUtils.getFileList(file.getAbsolutePath(), mFileFilter, mIsGreater, mFileSize,mSortFileUp);
            if (files == null) {
