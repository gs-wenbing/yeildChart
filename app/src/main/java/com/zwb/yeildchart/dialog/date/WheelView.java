...
public class WheelView extends View {
     ...
     * Items text color
     */
    private int mItemsTextColor = 0xFF000000;
...
//	private GradientDrawable bottomShadow;
    ...
    private void initResourcesIfNecessary() {
        if (itemsPaint == null) {
            ...
            itemsPaint.setTextSize((int) (14 * fontScale + 0.5f));
            itemsPaint.setShadowLayer(0.1f, 0, 0.1f, 0xFF000000);
        }
        ...
        if (valuePaint == null) {
            ...
            final float fontScale = getContext().getResources().getDisplayMetrics().scaledDensity;
            valuePaint.setTextSize((int) (14 * fontScale + 0.5f));
...
//					R.drawable.wheel_val);
            centerDrawable = getContext().getResources().getDrawable(mForegroundResId);
...
//	}
    ...
    private void drawItems(Canvas canvas) {
        ...
        itemsPaint.setColor(mItemsTextColor);
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        centerDrawable.setBounds(0, center - offset - mExtraHeight, getWidth(), center
                + offset + mExtraHeight);
     ...
     * 设置背景色
     */
    public void setBackgroudColor(int backgroundResId) {
